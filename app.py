...
trace1 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['binance_vol_in_btc'],
                    ...
                    text=["<b>Exchange: Binance</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                ['binance_vol_in_btc'], \
                                                                spot_exchanges_volume['date'])], \
                                                                    hoverinfo='text')
trace2 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['gdax_vol_in_btc'],
                    mode='lines', name='Coinbase',
                    text=["<b>Exchange: Coinbase</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['gdax_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                        hoverinfo='text')
trace3 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['kraken_vol_in_btc'],
                    ...
                    text=["<b>Exchange: Kraken</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['kraken_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                        hoverinfo='text')
trace4 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['kucoin_vol_in_btc'],
                    ...
                    text=["<b>Exchange: Kucoin</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['kucoin_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                        hoverinfo='text')
trace5 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['bitstamp_vol_in_btc'],
                    ...
                    text=["<b>Exchange: Bitstamp</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['bitstamp_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                        hoverinfo='text')
trace6 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['okex_vol_in_btc'],
                    mode='lines', name='OKX',
                    text=["<b>Exchange: OKX</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['okex_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                        hoverinfo='text')
trace7 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['bitfinex_vol_in_btc'],
                    ...
                    text=["<b>Exchange: Bitfinex</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['bitfinex_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                    hoverinfo='text')
trace8 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['huobi_vol_in_btc'],
                    ...
                    text=["<b>Exchange: Huobi</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                          .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['huobi_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                        hoverinfo='text')
trace9 = go.Scatter(x=spot_exchanges_volume['date'], y=spot_exchanges_volume['gemini_vol_in_btc'],
                     ...
                     text=["<b>Exchange: Gemini</b><br>Trading Vol.: {:,.2f} BTC<br>Date: {}"\
                           .format(vol, date) for vol, date in zip(spot_exchanges_volume\
                                                                  ['gemini_vol_in_btc'], \
                                                                  spot_exchanges_volume['date'])], \
                                                                        hoverinfo='text')
...
layout_fig6 = go.Layout(
    ...
    xaxis={'title': 'Date'},
    yaxis={'title': 'Total Capacity', 'side': 'left', 'showgrid': False},
    yaxis2={
        'title': 'Channel Count',
        'side': 'right',
        'overlaying': 'y',
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.P([
            "Data for this analysis is originally sourced from CoinGecko, mempool, and Yahoo \
                Finance, and has been systematically cleaned and transformed. For detailed \
                    methodology, visit my ",
            html.A("GitHub repo", href="https://github.com/ru4871SG/bitcoin-analysis-plotly-dash", \
                   target="_blank", className="repo_link", id="repo_link_1")
        ], className="paragraph_text", id="tutorial_text"),

        html.H3("Key Insights:", className="heading_text", id="key_insight_heading"),

        html.Ul([
            html.Li("In Q3 2023, Bitcoin price action has not been tightly correlated to \
                    NDX or Gold"),
            html.Li("In the month of September, Bitcoin median tx fee were usually low, \
                    peaked at 29 sat/vB"),
            html.Li("Foundry USA and AntPool are still leading the mining pool distribution"),
            html.Li("Binance is still leading the spot trading volume data, with peak activities \
                    around July 14th and August 18th"),
        ...
        html.Div([
            ...
            html.H2("Bitcoin Price Action vs. NDX and Gold", className="heading_text", \
                    id="heading_text_1"),

            html.P("You can choose the start and end dates below (the min. date is July 5th, \
                   while max. date is September 28th)", className="citation_text", \
        ...
        html.P("P.S.: July 3rd and July 4th data were omitted because the U.S. stock market closed \
               early on July 3rd, and was fully closed on July 4th. The dates above followed the \
               U.S. stock market open days for chart consistency.",
        ...
        html.Div([
            ...
            html.H2("Correlation Analysis: Bitcoin vs. NDX and Gold", className="heading_text", \
                    id="heading_text_2"),
            ...
            html.Div([
                html.P("Choose the y-axis. BTC vs. ", className="paragraph_text", \
                       id="text_pre_dropdown_1"),
                dcc.Dropdown(
                    id='y-axis-dropdown',
        ...
        html.P("My second analysis uses EDA (Exploratory data analysis) with scatter plots to \
        ...
        html.P("You can see there are a lot of data points that are far away from the trend line. \
               This finding indicates a lot of variability. That means Bitcoin price action (between \
               July and September) did not closely follow the price action of NDX or Gold.", \
        ...
        html.Div([
            ...
            html.H2("Bitcoin Block Analysis - Median Tx Fee", className="heading_text", \
                    id="heading_text_3"),
            dcc.Graph(id='mempool-stats-chart', figure=fig3, className='graph-bg-dark'),

        html.P("Now, let's check the Bitcoin block data directly from mempool to see the median \
        ...
        html.P("Disclaimer: Because of the variance in the network's hashing power, the number 144 \
               is just a target.", \
        ...
        html.Div([
            ...
            html.P("This section analyzes Bitcoin mining pools' distribution from mempool. Foundry \
        ...
        html.P("Let's check the cryptocurrency spot exchanges' volume data. I decided to check \
               ...
               Coinbase, Kraken, OKX, etc.", className="paragraph_text", id="paragraph_text_5_1"),
        ...
        html.P("The above chart shows that Binance still dominates the market as always, with peak \
               activities around July 14th and August 18th. Even in the last days of September, Binance's \
                   trading volume still surpassed 133K Bitcoin per day. These details are essential because \
                       ...
                       market because Bitcoin dominates this industry, especially \
                       in the bear market.", className="paragraph_text", id="paragraph_text_5_2"),
        ...
        html.P("Now, let's analyze the Lightning Network (LN) data. Many cryptocurrency advocates \
...
def update_scatter_chart(y_axis_variable):
    """function to update the scatter plot's y-axis"""
    fig2_data = btc_90d_w_external_and_months

    y_axis_label = y_axis_labels.get(y_axis_variable, "UNKNOWN")

    # Compute linear regression line using sklearn
    x_line = fig2_data["btc_price_normalized"].values.reshape(-1, 1)
    y_line = fig2_data[y_axis_variable].values
    model = LinearRegression().fit(x_line, y_line)
    ...
    fig2.add_trace(go.Scatter(x=fig2_data['btc_price_normalized'], \
                              y=y_pred, mode='lines', \
                                name='Trend Line', line={'color': '#a2823c'}))
