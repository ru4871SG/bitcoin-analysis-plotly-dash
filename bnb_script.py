"""
Data Import and Wrangling Steps - BNB
"""
...
def format_value(data, value):
    """function to format the value in bnb_combined_data_final"""
    conditions = [
...
bnb_combined_data_final['Value'] = bnb_combined_data_final.apply(lambda row: \
...
for protocol in bnb_defi_protocol_list_names:
    ...
    bnb_defi_tvl_data = data['chainTvls']['BSC']['tvl'] if 'BSC' in data['chainTvls'] else \
                        data['chainTvls'].get('Binance', {}).get('tvl', [])
                        
    bnb_defi_tvl = pd.DataFrame(bnb_defi_tvl_data)
...
bnb_90d.to_pickle('pickles/unassigned/bnb_90d.pkl')
bnb_gas_fee.to_pickle('pickles/unassigned/bnb_gas_fee.pkl')
bnb_combined_data_final.to_pickle('pickles/unassigned/bnb_combined_data_final.pkl')
bnb_tvl.to_pickle('pickles/unassigned/bnb_tvl.pkl')
bnb_defi_tvl_top10.to_pickle('pickles/unassigned/bnb_defi_tvl_top10.pkl')
